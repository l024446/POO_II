 ...
 * @author l024446
 */
public class SalvaNovoColaborador {
    
    public SalvaNovoColaborador (int id, String nome, String endereço, String telefone, String celular, String email, int documento, ColecoesDeDados arquivo){
        Colaborador aux = new Colaborador (id, nome, endereço, telefone, celular, email, documento);
        arquivo.addColaborador(id, aux);
        }
}
